## pepper_meshes (rolling) - 3.0.0-1

The packages in the `pepper_meshes` repository were released into the `rolling` distro by running `/root/Code/Palaio/naoqi-ros2-control/bloom-venv/bin/bloom-release -y --no-web --no-pull-request --override-release-repository-url https://github.com/ros-naoqi/pepper_meshes2-release.git -r rolling -t rolling pepper_meshes` on `Mon, 22 Jun 2026 09:40:11 -0000`
